      ...
      <!--<div class="image bg-image" style="background-image: url('images/img_1.jpg');"></div>-->
         <div class="col-lg-6 mb-10">
            <form  method="post" align="center">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <center><label class="font-weight-bold" for="fullname"><font size="16">Forgot password</font></label></center>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12">
			...
			<!--<div class="row form-group">
              ...
              <div class="row form-group">
                <div class="col-md-12" align="center">
                  <input type="submit" name="otp" value="send otp" class="btn btn-primary pill text-white px-5 py-2">
                </div>
              </div>
			  <!--<div class="row form-group">
				<div class="col-md-12" align="center">
...
if(isset($_POST['otp']))
{
	...
	$rand=rand(111111,999999);
		$_SESSION['otp']=$rand;
		$_SESSION['email']=$email;
		$res = mysqli_query($con,"select * from tbl_user where user_email='$email'");
		if(mysqli_num_rows($res)>0)
		{
			require'PHPMailer-master/PHPMailerAutoload.php';
				...
				$mail->Body="<h1 align=center>Online Expenditure Dairy</h1><h4 align=center>Your one time password is <b>$rand</b></h4>";
			...
			echo "alert('Check Your Mail and Enter otp');";
		...
		{
			echo "<script type='text/javascript'>";
			echo "alert('your email id is not avalible');";
			echo "</script>";
		}
